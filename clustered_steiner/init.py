...
from individual_mfea import individual_mfea
import utils
...
def init_population_mfea(population_size,chromosomes_size):

    chromosomes = []
    for _ in range(population_size):
        encode = init_encode(chromosomes_size)
        chromosomes.append(encode)
